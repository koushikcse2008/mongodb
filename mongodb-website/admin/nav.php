...
<nav class="navbar navbar-expand-lg navbar-dark bg-success">
    <div class="container-fluid">
        <a class="navbar-brand" href="index.php">PHP MONGODB ADMIN</a>
        ...
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item">
                <a class="nav-link <?php echo (($page_name == "pages_list.php")||($page_name == "pages_edit.php")) ? 'active' : ''; ?>" aria-current="page" href="pages_list.php">Pages List</a>
            </li>
            <li class="nav-item">
                <a class="nav-link <?php echo ($page_name == "contacts_list.php") ? 'active' : ''; ?>" href="contacts_list.php">Contacts List</a>
            </li>
